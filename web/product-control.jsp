...
<html lang="en">
                        ...
                        <c:forEach items="${listP}" var="o">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="DeleteProductControl?pid=${o.productID}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
        ...
        <div id="addEmployeeModal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="AddProductControl" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                                <label>Image</label>
                                <input name="image" type="file" id="file-upload-1" required />
                                <input name="images" type="file" id="file-upload-2" multiple required />
                            </div>
                            <div class="form-group">
                                <label>Price</label>
                            ...
                            <div class="form-group">
                                ...
                                <input name="color" type="checkbox"  value="${o.colorID}">${o.colorName} 
                                    </c:forEach>
                                    <label>Size</label>
    ...
    <script>
        $('input[type=file]').change(function () {
            console.log($('input[type=file]').val().split('\\').pop());
});
    </script>
</body>
</html>