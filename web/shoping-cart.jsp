<%-- 
    ...
    Created on : Jan 15, 2022, 9:55:50 PM
    Author     : ADMIN
--%>
...
<html lang="en">
    ...
    <body class="animsition">
        ...
        <jsp:include page="your-cart-importer.jsp"></jsp:include>
            ...
            <!-- Shoping Cart -->
            <form class="bg0 p-t-75 p-b-85" action="bill" method="POST">
                <div class="container">
                    <div class="row">
                                    ...
                                    <div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
                                        ...
                                        <div class="p-t-15">
                                            ...
                                            <div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">                                        
                                                <select class="js-select2" name="payment" id="payment" required >                                          
                                            ...
                                            <div class="bor8 bg0 m-b-22">
                                                <input class="stext-111 cl8 plh3 size-111 p-lr-15" type="tel" id="phone" name="phone"
